    ...
    >
      ...
      <div class="flex flex-col justify-center items-end w-full lg:w-1/2 gap-14">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <p class="text-white text-lg">
            excellent communication and teamwork abilities, I thrive in collaborative environments, responsible, ability
            to manage and motivate others
          </p>
        </div>
      </div>
      <!-- #2 -->
      <div class="relative flex justify-center items-center z-10">
        ...
        <img
          ...
          src="../../public/images/svg/waves.svg"
          width="250"
          height="250"
        />
      </div>
      <img
        ...
        src="../../public/images/svg/plus-color.svg"
        width="150"
        height="100"
      />
    </div>
